...
export const theme = {
  ...
  shadow: {
    ...
    cardHover: '0 8px 12px -2px rgba(0, 0, 0, 0.04), 0 4px 8px -2px rgba(0, 0, 0, 0.02), 0 28px 40px -8px rgba(0, 0, 0, 0.06)',
    tooltip: '0 10px 25px -5px rgba(0, 0, 0, 0.05), 0 8px 10px -6px rgba(0, 0, 0, 0.05)',
  },
  ...
  gradients: {
    eggsPoultry: 'linear-gradient(135deg, #fff7e0 0%, #ffedc2 55%, #fff9ec 100%)',
    ...
    vegetables: 'linear-gradient(135deg, #eafbe9 0%, #d3f3d0 55%, #f4fdf3 100%)',
